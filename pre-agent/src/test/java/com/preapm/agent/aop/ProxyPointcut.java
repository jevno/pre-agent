...
//        proxyPointcut.setExpression("execution(public * com.dominos.cloud.*.controller.*.*(..))");
...
//        System.out.println(matches);
        Method method = ClassLoaderTest.class.getMethods()[0];
        System.out.println(method.toString());
        System.out.println(proxyPointcut.matches(method));
    }
}
