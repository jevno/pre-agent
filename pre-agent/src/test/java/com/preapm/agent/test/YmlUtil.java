...
public class YmlUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        YmlUtil.loadYml("test.yml");

        LinkedHashMap value = (LinkedHashMap)YmlUtil.getValue("target:set");

        value.keySet().forEach(key ->{
//            System.out.println(key);
            try {
                String str = "target:set" + ":" + key + ":value";


                Object value1 = YmlUtil.getValue(str);
