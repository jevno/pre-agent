package com.preapm.agent.weave.parser;
...
public class PrePointcutParser {
    private PreReflectionWorld world;
     ...
     * </p>
     */
    public static PrePointcutParser getPointcutParserSupportingAllPrimitivesAndUsingContextClassloaderForResolution() {
        PrePointcutParser p = new PrePointcutParser();
     ...
     */
    public static PrePointcutParser getPointcutParserSupportingSpecifiedPrimitivesAndUsingContextClassloaderForResolution(
            Set<PointcutPrimitive> supportedPointcutKinds) {
        PrePointcutParser p = new PrePointcutParser(supportedPointcutKinds);
        p.setClassLoader(Thread.currentThread().getContextClassLoader());
        return p;
    }
     ...
     * </p>
     */
    public static PrePointcutParser getPointcutParserSupportingAllPrimitivesAndUsingSpecifiedClassloaderForResolution(
     ...
     * @throws UnsupportedOperationException if the set contains if, cflow, or cflow below
     */
    public static PrePointcutParser getPointcutParserSupportingSpecifiedPrimitivesAndUsingSpecifiedClassLoaderForResolution(
     ...
     * @throws UnsupportedOperationException if the set contains if, cflow, or cflow below
     */
    private PrePointcutParser(Set<PointcutPrimitive> supportedPointcutKinds) {
    ...
    protected void setWorld(PreReflectionWorld aWorld) {
        this.world = aWorld;
    }
    ...
    protected void setClassLoader(ClassLoader aLoader) {
        ...
        world = PreReflectionWorld.getReflectionWorldFor(this.classLoaderReference);
    }
    ...
    protected void setClassLoader(ClassLoader aLoader, boolean shareWorlds) {
        ...
        if (shareWorlds) {
            ...
            world = new PreReflectionWorld(classLoaderReference);
        }
    }
     ...
     */
    public PrePointcutExpressionImpl parsePointcutExpression(String expression) throws UnsupportedPointcutPrimitiveException,
     ...
     * @throws IllegalArgumentException if the expression is not a well-formed pointcut expression
     */
    public PrePointcutExpressionImpl parsePointcutExpression(String expression, Class<?> inScope, PointcutParameter[] formalParameters)
            throws UnsupportedPointcutPrimitiveException, IllegalArgumentException {
        PrePointcutExpressionImpl pcExpr = null;
        try {
            Pointcut pc = resolvePointcutExpression(expression, inScope, formalParameters);
            pc = concretizePointcutExpression(pc, inScope, formalParameters);
            validateAgainstSupportedPrimitives(pc, expression); // again, because we have now followed any ref'd pcuts
            pcExpr = new PrePointcutExpressionImpl(pc, expression, formalParameters, getWorld());
