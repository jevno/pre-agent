...
public class ProxyPointcut {
    ...
    private AopExpressBean aopExpressBean;

    public AopExpressBean getAopExpressBean() {
        return aopExpressBean;
    }

    public void setAopExpressBean(AopExpressBean aopExpressBean) {
        this.aopExpressBean = aopExpressBean;
    }
